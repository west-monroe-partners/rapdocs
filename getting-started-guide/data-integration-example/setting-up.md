...
![S3 Bucket Search](../../.gitbook/assets/image%20%28175%29.png)

In the training bucket, there should be an **input** and **output** folder.

![Training Folder](../../.gitbook/assets/image%20%28154%29.png)

## Step 3: Create a Unique Input Folder

Select the **input** folder.

![Input Folder](../../.gitbook/assets/image%20%2899%29.png)
...
![Create Input Initials Folder](../../.gitbook/assets/image%20%2886%29.png)

Select the input folder with your initials.

![Select Initials Folder](../../.gitbook/assets/image%20%2850%29.png)

In the input initials folder, select **Upload**.

![Upload Button](../../.gitbook/assets/image%20%28173%29.png)
...
![Upload File](../../.gitbook/assets/image%20%2853%29.png)
...
![Navigation to the training folder](../../.gitbook/assets/image%20%2834%29.png)

Select the `output` folder.

![Output Folder](../../.gitbook/assets/image%20%2893%29.png)
...
![Create Output Initials Folder](../../.gitbook/assets/image%20%28124%29.png)
