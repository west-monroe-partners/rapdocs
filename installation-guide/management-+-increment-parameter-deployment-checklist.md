# Management + Increment Parameter Deployment Checklist
...
| **VPC Configuration** |  |  |
| vpcincrcidr | Enter the Increment VPC CIDR Reservation. Default is 10.1.0.0/16 | 10.1.0.0/16 |
| vpcmgmtcidr | Enter the Management VPC CIDR. Default is 10.0.0.0/16 | 10.0.0.0/16 |
| **Subnet Configuration** |  |  |
| submgmtaz1 | Enter the Management VPC's AZ1 Subnet Reservation. Default is 10.0.1.0/24 | 10.0.1.0/24 |
| submgmtaz2 | Enter the Management VPC's AZ2 Subnet Reservation. Default is 10.0.2.0/24 | 10.0.2.0/24 |
| subappaz1 | Enter the Increment VPC's AZ1 Application Tier Subnet Reservation. Default is 10.1.2.0/24 | 10.1.2.0/24 |
| subappaz2 | Enter the Increment VPC's AZ2 Application Tier Subnet Reservation. Default is 10.1.5.0/24 | 10.1.5.0/24 |
| subdbaz1 | Enter the Increment VPC's AZ1 Database Tier Subnet Reservation. Default is 10.1.3.0/24 | 10.1.3.0/24 |
| subdbaz2 | Enter the Increment VPC's AZ2 Database Tier Subnet Reservation. Default is 10.1.6.0/24 | 10.1.6.0/24 |
| subwebaz1 | Enter the Increment VPC's AZ1 Web Tier Subnet Reservation. Default is 10.1.1.0/24 | 10.1.1.0/24 |
| subwebaz2 | Enter the Increment VPC's AZ2 Web Tier Subnet Reservation. Default is 10.1.4.0/24 | 10.1.4.0/24 |
| **EC2 IPv4 Allocation** |  |  |
| apiip | Enter the Increment VPC's API Private IPv4 Reservation in the AZ1 Web Tier. Default is 10.1.2.100 | 10.1.2.100 |
| vpnip | Enter the Management VPC's OpenVPN Private IPv4 Reservation in the AZ1 Tier. Default is 10.0.1.50 | 10.0.1.50 |
| bkpvpnip | Enter the Management VPC's Backup OpenVPN Private IPv4 Reservation in the AZ1 Tier. Default is 10.0.2.50 | 10.0.2.50 |
| etlip | Enter the Increment VPC's ETL Private IPv4 Reservation in the AZ1 Application Tier. Default is 10.1.2.150 | 10.1.2.150 |
| pwrbigwip | Enter the Increment VPC's PowerBI Gateway Private IPv4 Reservation in the AZ1 Application Tier. Default is 10.1.2.125 | 10.1.2.125 |
| sftpip | Enter the Increment VPC's SFTP Private IPv4 Reservation in the AZ1 Web Tier, Default is 10.1.1.100 | 10.1.1.100 |
| **EC2 Instance Type** |  |  |
