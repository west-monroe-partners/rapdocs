...
The S3 bucket has been removed, it will need to be emptied and deleted during the Terraform upgrade. In addition, a container named ui has been created that will be added to the ECS cluster. The container will resolve to the same UI DNS as before and traffic will be routed through a new route in the Load Balancer. &#x20;
